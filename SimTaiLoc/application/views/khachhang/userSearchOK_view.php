...
<table class="table table-bordered">
							...
							<tbody class="thead">
									...
									<?php foreach ($mangkqtimkiem as $key => $value): ?>
										<form action="<?php echo base_url(); ?>index.php/addOrder/insertData_controller" method="post" enctype="multidata/form-data"> 
										 <div class="col-sm-4">
											<div class="">
												<tr>
													<td><?= $value['id'] ?></td>	
													...
													<td>
														...
														<!-- <a href="../khachhang_showData/editSim/<?= $value['id'] ?> " class="btn btn-success xoa" title="mua sim"> <i class="fa fa-pencil"></i>Đặt Mua</a> -->
														<a href="../khachhang_showData/thanhtoan " class="btn btn-success xoa" title="mua sim"> <i class="fa fa-pencil"></i>Đặt Mua</a>
